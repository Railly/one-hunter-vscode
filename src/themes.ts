    ...
    default: [
      {
        scope: ["comment"],
        settings: {
          foreground: OneHunterColors.gray,
        },
      },
      {
        scope: [
      ...
      },
      {
        ...
        settings: {
          foreground: OneHunterColors["meta.object-literal.key.tsx"],
          fontStyle: "normal",
        },
      },
      {
      ...
      },
      {
        ...
        settings: {
          foreground: OneHunterColors.info,
        },
      },
      {
        scope: "token.warn-token",
        settings: {
          foreground: OneHunterColors.warn,
        },
      },
      {
        scope: "token.error-token",
        settings: {
          foreground: OneHunterColors.error,
        },
      },
      {
        scope: "token.debug-token",
        settings: {
          foreground: OneHunterColors.debug,
        },
      },
      /* Typescript / React */
      {
